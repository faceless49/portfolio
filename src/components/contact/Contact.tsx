  ...
  return (
    <section className={s.contact}>
      ...
      <div className={s.contact_form}>
        ...
        <a className={s.social_link} href={'https://join.skype.com/invite/gAuhYur2ltk2'}><FontAwesomeIcon icon={['fab', 'skype']} size={'2x'}/></a>
        <a className={s.social_link} href={'mailto:kolesnikov49r@gmail.com'}><FontAwesomeIcon icon={['far', 'envelope']} size={'2x'}/></a>
      </div>
    </section>
  );
};
